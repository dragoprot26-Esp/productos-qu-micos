...
export default function AdminPanel({
  ...
  const handleExportCSV = () => {
    const headers = 'Código;Cliente;Teléfono;Artículos;Total;Modalidad;Estado;Fecha\n';
    const rows = tenantOrders.map(o => {
      ...
      return `${o.code};${o.customerName};${o.customerPhone};"${itemsString}";$${o.total};${o.deliveryType === 'delivery' ? 'Envío' : 'Retiro'};${o.status};${dateStr}`;
    }).join('\n');
